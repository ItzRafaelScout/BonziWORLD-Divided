...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "pingu", src: "./img/bonzi/pingu.png" },
	...
	{ id: "bonziScarlet", src: "./img/bonzi/scarlet.png" },
        { id: "bonziAmber", src: "./img/bonzi/amber.png" },
	{ id: "bonziChartreuse", src: "./img/bonzi/chartreuse.png" },
	{ id: "bonziSeaGreen", src: "./img/bonzi/seagreen.png" },
	{ id: "bonziAzure", src: "./img/bonzi/azure.png" },
	{ id: "bonziMagenta", src: "./img/bonzi/magenta.png" },
	{ id: "bonziOlive", src: "./img/bonzi/olive.png" },
	{ id: "bonziGrey", src: "./img/bonzi/grey.png" },
	{ id: "bonziGunmetal", src: "./img/bonzi/gunmetal.png" },
	{ id: "bonziVantaBlack", src: "./img/bonzi/vantablack.png" },
	{ id: "bonziVantaBlack", src: "./img/bonzi/mametchi.png" },
...
function setup() {
    $("#chat_send").click(sendInput),
        ...
        socket.on("crap", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.crap(a.target);
        }),
	socket.on("getout", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.getout(a.target);
        }),
	socket.on("shit", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.shit(a.target);
        }),
	...
	socket.on("video", function (a) {
        ...
        socket.on("bannedword", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.bannedword();
        }),
...
var _createClass = (function () {
    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            (this.x = e.x * this.rng()),
                        ...
                        return {
                            items: {
                                ...
                                crap: {
                                    name: "Crapify",
                                    callback: function () {
                                        socket.emit("command", { list: ["crap", d.userPublic.name] });
                                    },
                                },
                                owo: {
                                    name: "Notice Bulge",
				...
				mute2: {
                                    name: "Call an Mute",
                                    callback: function () {
                                        socket.emit("command", { list: ["fake_mute", d.userPublic.name] });
                                    },
                                },
				shit: {
                                    name: "Call an Shit",
                                    callback: function () {
                                        socket.emit("command", { list: ["shit", d.userPublic.name] });
                                    },
                                },
				getout: {
                                    name: "Go Get Out",
                                    callback: function () {
                                        socket.emit("command", { list: ["getout", d.userPublic.name] });
                                    },
                                },
                                kick: {
                                    disabled: function () {
                ...
                },
		{
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            this.$dialogCont.html("<img width='170' src='" + a + "'></img>"),
                            this.$dialog.show();
                        }
                    },
                },
                ...
                },
		{
                    key: "muted",
                    value: function (a) {
                        this.runSingleEvent([{ type: "text", text: "Hey, " + a + "!" }, 
                ...
                },
                {
                    ...
                    value: function (a) {
                        this.runSingleEvent([
                            { type: "text", text: "Hey, " + a + "!. You're a antarctic crap!", say: "Hey, " + a + "!. your a antarctic crap!"},
                ...
                },
		{
                    ...
                    value: function (a) {
                        this.runSingleEvent([{ type: "text", text: "Hey, " + a + "!" }, 
					     { type: "text", text: "You're Are Shit!", say: "your are shit!" }, 
					     { type: "anim", anim: "clap_fwd", ticks: 15 }, 
					     { type: "idle" }]);
                    },
                },
		{
                    ...
                    value: function (a) {
                        this.runSingleEvent([{ type: "text", text: "Hey, " + a + "!" }, 
					     { type: "text", text: "Get out!", say: "get out!" }
					    ]);
                    },
                },
                {
                    ...
                    value: function (a) {
                        this.runSingleEvent([
                            { type: "text", text: "sorry, this word is blacklisted.", say: "sorry, this word is blacklisted." },
                        ]);
                    },
                },
                {
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "blue", "brown", "green", "purple", "red", "pink", "yellow", 
				  "cyan", "orange", "scarlet", "amber", "chartreuse", "seagreen",
				  "azure", "magenta", "olive", "grey", "gunmetal", "vantablack", "pingu", 
				  "mametchi", "pope"], b = 0; b < a.length; b++) {
                        var c = a[b],
                        if (c == 'mametchi') {
                            d = { images: ["./img/bonzi/" + c + ".png"], frames: BonziData.sprite.mametchi.frames, animations: BonziData.sprite.mametchi.animations };
                        } else {
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziGreen", "bonziPurple", 
	"bonziRed", "bonziPink", "bonziYellow", "bonziCyan", 
	"bonziOrange", "bonziScarlet", "bonziAmber", "bonziChartreuse", 
	"bonziSeaGreen", "bonziAzure", "bonziMagenta", "bonziOlive", "bonziGrey", 
	"bonziGunmetal", "bonziVantaBlack", "pingu", "mametchi", "topjej"];
